<footer class="footer appear-animate">
                            ...
                            <div class="row row-sm">
                                ...
                                <div class="col-sm-4">
                                    <div class="widget">
                                        ...
                                        <ul class="links">
                                            <li><a href="about.html">Super Fast Wordpress Theme</a></li>
                                            <li><a href="contact.html">Top Rated Theme in Themeforest</a></li>
            ...
            <div class="container">
                <div class="footer-bottom">
                    <span class="footer-copyright">© copyright {{date('Y', time())}}. All Rights Reserved.</span>
                    <img src="/storage/images/payments.png" alt="payment methods" width="240" height="32" class="footer-payments"/>
