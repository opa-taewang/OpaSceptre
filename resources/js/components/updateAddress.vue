<template>
    <div class="container">
        <a :href="'#'+url" title="Edit" class="step-title-edit" data-toggle="modal">
            <span class="sr-only">Edit</span><i class="icon-pencil"></i>
        </a>

        <div class="modal fade mx-auto" :id="url" tabindex="-1" role="dialog" :aria-labelledby="url" aria-hidden="true">
